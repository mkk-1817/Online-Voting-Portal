...
const SignUp = () => {
  ...
  const handleEmailVerify = async () => {
    try {
      ...
      const response = await axios.post('https://online-voting-portal-mkk-1817s-projects.vercel.app/sendotp', { email: formData.email });
  ...
  const handleVerifyOTP = async () => {
    try {
      ...
      const response = await axios.post('https://online-voting-portal-mkk-1817s-projects.vercel.app/verifyotp', { email: formData.email, enteredOTP: otp });
      if (response.status === 200) {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      const response = await axios.post('https://online-voting-portal-mkk-1817s-projects.vercel.app/signup', formData);
      if (response.status === 200) {
