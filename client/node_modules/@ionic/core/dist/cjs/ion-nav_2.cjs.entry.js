...
const Nav = class {
    ...
    render() {
        return index.h("slot", { key: '8254ea10bef0575c13f8b0ddbe4643bec19f2366' });
    }
...
const NavLink = class {
    ...
    render() {
        return index.h(index.Host, { key: 'dfbfc1a69c48248a8861463ed31c693be6543f32', onClick: this.onClick });
    }
    get el() { return index.getElement(this); }
};
