...
const Footer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6f2827ba2e64d1a889c0631bc2a6d5df97b338ce', role: "contentinfo", class: {
                [mode]: true,
            ...
            } }, mode === 'ios' && translucent && index.h("div", { class: "footer-background" }), index.h("slot", { key: 'b07574feb587a1089b001e7d158fd8d05e32304b' })));
    }
    get el() { return index.getElement(this); }
};
Footer.style = {
...
const Header = class {
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: 'be4386a218c20dc4c18320dbbcfb25574d13d27e', role: roleType, class: {
                [mode]: true,
                // Used internally for styling
                [`header-${mode}`]: true,
            ...
            } }, inheritedAttributes), mode === 'ios' && translucent && index.h("div", { class: "header-background" }), index.h("slot", { key: '74c401fb331aeb40c733605fd580949ad53989b8' })));
    }
    get el() { return index.getElement(this); }
};
Header.style = {
...
const RouterOutlet = class {
    ...
    render() {
        return index.h("slot", { key: 'e4eaa40478f70742d0ff7602ed5f83879da9f1b4' });
    }
    get el() { return index.getElement(this); }
...
const ToolbarTitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        const size = this.getSize();
        return (index.h(index.Host, { key: '2642d433ba678b67503b7f1e9d0ae0390250bec8', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`title-${size}`]: true,
                'title-rtl': document.dir === 'rtl',
            }) }, index.h("div", { key: '355184542e26b53296f7143d099cfebc3de7b569', class: "toolbar-title" }, index.h("slot", { key: 'aed07a34c22e4b1f34cdf40fea35481674d8941f' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "size": ["sizeChanged"]
...
const Toolbar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fdd8621b4f69ce650b5aaf4fb6bffde29aa5ad65', class: Object.assign(Object.assign({}, childStyles), theme.createColorClasses(this.color, {
                [mode]: true,
                'in-toolbar': theme.hostContext('ion-toolbar', this.el),
            })) }, index.h("div", { key: 'c6ad5434546e2046a83574ea92a03a3f77d0a9e3', class: "toolbar-background" }), index.h("div", { key: '3b79dd20c3e8252cacfd46a82428df9ba0b8b86e', class: "toolbar-container" }, index.h("slot", { key: '514259a8b76db9f3a587a7667b5e37fd8ade9481', name: "start" }), index.h("slot", { key: 'd9ab68f0626f4ac8b83d21663eb67a47b76d809b', name: "secondary" }), index.h("div", { key: '2c21da88b67a7d7eef280e517bda9982264c7be4', class: "toolbar-content" }, index.h("slot", { key: 'ac2b7c8f20c5ac755df9032809c73eab9e767e36' })), index.h("slot", { key: '2ddd3b7e3803f2d56c32743dcfc114ddcb8684a2', name: "primary" }), index.h("slot", { key: '27483847d4333b4492506da33185c9ba1aa824a7', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
Toolbar.style = {
