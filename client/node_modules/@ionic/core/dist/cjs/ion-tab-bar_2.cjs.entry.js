...
const TabBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '51e4bdbce8c7107c1114a39618b4a9a941876bb1', role: "tablist", "aria-hidden": shouldHide ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                'tab-bar-translucent': translucent,
                'tab-bar-hidden': shouldHide,
            }) }, index.h("slot", { key: 'c11618f97e93deb0a56f33c904481b4811c685ec' })));
    }
...
const TabButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '32ec1fb183523dadaaed6689add4a042d0fdd69a', onClick: this.onClick, onKeyup: this.onKeyUp, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                [mode]: true,
                ...
                'ion-selectable': true,
                'ion-focusable': true,
            } }, index.h("a", Object.assign({ key: '9e56304c52e30ae3a3dca434fa0b41eccc873faa' }, attrs, { class: "button-native", part: "native", role: "tab", "aria-selected": selected ? 'true' : null, "aria-disabled": disabled ? 'true' : null, tabindex: disabled ? '-1' : undefined }, inheritedAttributes), index.h("span", { key: '34eae18c23584742a25d20b4038aa1742d9ab0d8', class: "button-inner" }, index.h("slot", { key: '4bc9629861f5ce3f1ef87ac77bc027ba0dea694c' })), mode === 'md' && index.h("ion-ripple-effect", { type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
TabButton.style = {
