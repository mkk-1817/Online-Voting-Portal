...
const InfiniteScroll = class {
    ...
    render() {
        ...
        const disabled = this.disabled;
        return (index.h(index.Host, { key: 'cf712b0f22fe89b41377402da44f5575118ed34f', class: {
                [mode]: true,
...
const InfiniteScrollContent = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '38c67d2c7ea4c304e71dacea64add0bffab69906', class: {
                [mode]: true,
                // Used internally for styling
                [`infinite-scroll-content-${mode}`]: true,
            } }, index.h("div", { key: 'a23484ccbaf65e0e3ecb59befea425cfdbc782fd', class: "infinite-loading" }, this.loadingSpinner && (index.h("div", { class: "infinite-loading-spinner" }, index.h("ion-spinner", { name: this.loadingSpinner }))), this.loadingText !== undefined && this.renderLoadingText())));
    }
};
