...
const ItemOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7e208b463b2d36984791a7c9c1d24af88b468a03', onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-option-disabled': disabled,
                'item-option-expandable': expandable,
                'ion-activatable': true,
            }) }, index.h(TagType, Object.assign({ key: '9f48210793e88f25b675add863453432e6d8be51' }, attrs, { class: "button-native", part: "native", disabled: disabled }), index.h("span", { key: '3ebb5d9b7369f77ca49c8d700a95e4e2335a7f24', class: "button-inner" }, index.h("slot", { key: '7df01a2c40554effe0e36e7fe29ac469a89ad395', name: "top" }), index.h("div", { key: '1bdc411990a89a0523dd170bf4d61c2f28af3018', class: "horizontal-wrapper" }, index.h("slot", { key: '967a0cc8ff611439fddf28c20c3f197be1a314a5', name: "start" }), index.h("slot", { key: '7848ded44ce1b0e303f1c1a423fc1ae51e5997d4', name: "icon-only" }), index.h("slot", { key: '6076bb1a50cebe374ecd8507133eaccd2ee2d08b' }), index.h("slot", { key: '71505008df081744492fb22b41229ada64506834', name: "end" })), index.h("slot", { key: 'c213321eafe801c1ace8573b4736c2f0ab585703', name: "bottom" })), mode === 'md' && index.h("ion-ripple-effect", null))));
    }
...
const ItemOptions = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '42ec58a1a2a6a886309595103468d2c39e81f58b', class: {
                [mode]: true,
...
const ItemSliding = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '83e1673fc5af892612deb9b49d5e792b8b0b6473', class: {
                [mode]: true,
