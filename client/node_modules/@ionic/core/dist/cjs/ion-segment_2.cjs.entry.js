...
const Segment = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0cf2e11e5599a0de2b0c7dc2a46917f4894ceb05', role: "tablist", onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
            ...
            }) }, index.h("slot", { key: '913f2e4a823d3a58ea074dfb95314651c46739db' })));
    }
...
const SegmentButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5fda697569eb875991bb948be553ee0716ac9aa2', class: {
                [mode]: true,
                'in-toolbar': theme.hostContext('ion-toolbar', this.el),
                'in-toolbar-color': theme.hostContext('ion-toolbar[color]', this.el),
                ...
                'ion-focusable': true,
            } }, index.h("button", Object.assign({ key: '86686e25d3bb8f487869a4d34c1e99a5d04105ec', "aria-selected": checked ? 'true' : 'false', role: "tab", ref: (el) => (this.nativeEl = el), type: type, class: "button-native", part: "native", disabled: disabled }, this.inheritedAttributes), index.h("span", { key: '5c22e853fd385e2b7825335113346537ecefed31', class: "button-inner" }, index.h("slot", { key: 'cef944331f246a820747f98dff55e844281cb822' })), mode === 'md' && index.h("ion-ripple-effect", null)), index.h("div", { key: '737b4b08c122a7738d5a5ed7a44f544da4c67649', part: "indicator", class: {
                'segment-button-indicator': true,
                'segment-button-indicator-animated': true,
            } }, index.h("div", { key: 'e78696ff315d7e8ba76b97b82ea341379e9be7e5', part: "indicator-background", class: "segment-button-indicator-background" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueChanged"]
