...
const ItemDivider = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'd9d5993694639e8f1ed589f0e8c3f4920ce30e02', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-divider-sticky': this.sticky,
                item: true,
            }) }, index.h("slot", { key: '1da8c38cbf07ef591ceae94b0d70bf620990e568', name: "start" }), index.h("div", { key: '349a581fd1688b01ce7c67da99ae22cb4a5a85f7', class: "item-divider-inner" }, index.h("div", { key: '80e22ba4f5da2af40bb32a445b840baa59edfbcc', class: "item-divider-wrapper" }, index.h("slot", { key: '6d3fb95c8eba128e56defccbcc5d4b1fa3ec4c4a' })), index.h("slot", { key: '83a97c131348c8cf840c30ccbf83c78edc125c14', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
ItemDivider.style = {
...
const ItemGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '1d7de42c40d5f37324342fa7be2420bf6499705e', role: "group", class: {
                [mode]: true,
...
const Label = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'c80cc1b4dcd56f614efc1e63ca80bca2f20a7151', class: theme.createColorClasses(this.color, {
                [mode]: true,
...
const List = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7f259d2a107807065a440cca848ececa0da60458', role: "list", class: {
                [mode]: true,
                // Used internally for styling
                [`list-${mode}`]: true,
                'list-inset': inset,
...
const ListHeader = class {
    ...
    render() {
        const { lines } = this;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '27a08e9dc880db9377608ea262e254b0856b0d5c', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`list-header-lines-${lines}`]: lines !== undefined,
            }) }, index.h("div", { key: 'edd68f126ee5d815e6ae13e9662e8cedbd2d46e5', class: "list-header-inner" }, index.h("slot", { key: 'dae94a382ef09bb90d3ff3fbb2306515acfc2014' }))));
    }
};
ListHeader.style = {
...
const Note = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'de9f59a3e1700776780e61def3044901e1d1bef5', class: theme.createColorClasses(this.color, {
                [mode]: true,
            }) }, index.h("slot", { key: '30f98649d4d31a297ab71d23ed38fa021540a8f2' })));
    }
};
Note.style = {
...
const SkeletonText = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '2d9e785d3026faf76d0e970e3bfe33258f29046b', class: {
                [mode]: true,
                'skeleton-text-animated': animated,
                'in-media': inMedia,
            } }, index.h("span", { key: 'd1800f5fd176a8daa216e8b889e427770bf64a05' }, "\u00A0")));
    }
    get el() { return index.getElement(this); }
};
