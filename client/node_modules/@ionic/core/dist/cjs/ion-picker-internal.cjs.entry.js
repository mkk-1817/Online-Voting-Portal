...
const PickerInternal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '49581a3c11cd7808555c576c46b833ac9d60f71a', onPointerDown: (ev) => this.onPointerDown(ev), onClick: () => this.onClick() }, index.h("input", { key: '92628e29f76914b955aa11d4e45797a941821159', "aria-hidden": "true", tabindex: -1, inputmode: "numeric", type: "number", onKeyDown: (ev) => {
                var _a;
                /**
            ...
            }, ref: (el) => (this.inputEl = el), onInput: () => this.onInputChange(), onBlur: () => this.exitInputMode() }), index.h("div", { key: '455d7ef6dd1425e882d86f49e0d817883fe222b2', class: "picker-before" }), index.h("div", { key: '0351296cf171d22840542eb178ec3fae1e90f5d5', class: "picker-after" }), index.h("div", { key: 'b4ecaa88d0bbbd69e72b3d4f27ad3bd91f3da84d', class: "picker-highlight", ref: (el) => (this.highlightEl = el) }), index.h("slot", { key: 'fac29c179707002861f39d2ba1ea53479d0d9b74' })));
    }
