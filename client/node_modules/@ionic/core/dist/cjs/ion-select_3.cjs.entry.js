...
const SelectOption = class {
    ...
    render() {
        return index.h(index.Host, { key: '69bd6a2dbbc0ab32cc607a74df10f3fb3d6e3295', role: "option", id: this.inputId, class: ionicGlobal.getIonMode(this) });
    }
    get el() { return index.getElement(this); }
};
...
const SelectPopover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '46e495ce7001131eb8b54073018de89401a99b81', class: ionicGlobal.getIonMode(this) }, index.h("ion-list", { key: 'afdb72359c3751c6b372af1a778398463d1da397' }, header !== undefined && index.h("ion-list-header", null, header), hasSubHeaderOrMessage && (index.h("ion-item", null, index.h("ion-label", { class: "ion-text-wrap" }, subHeader !== undefined && index.h("h3", null, subHeader), message !== undefined && index.h("p", null, message)))), this.renderOptions(options))));
    }
    get el() { return index.getElement(this); }
};
SelectPopover.style = {
