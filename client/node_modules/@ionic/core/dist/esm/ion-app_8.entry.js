...
const Footer = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6f2827ba2e64d1a889c0631bc2a6d5df97b338ce', role: "contentinfo", class: {
                [mode]: true,
            ...
            } }, mode === 'ios' && translucent && h("div", { class: "footer-background" }), h("slot", { key: 'b07574feb587a1089b001e7d158fd8d05e32304b' })));
    }
    get el() { return getElement(this); }
};
Footer.style = {
...
const ToolbarTitle = class {
    ...
    render() {
        const mode = getIonMode(this);
        const size = this.getSize();
        return (h(Host, { key: '2642d433ba678b67503b7f1e9d0ae0390250bec8', class: createColorClasses(this.color, {
                [mode]: true,
                [`title-${size}`]: true,
                'title-rtl': document.dir === 'rtl',
            }) }, h("div", { key: '355184542e26b53296f7143d099cfebc3de7b569', class: "toolbar-title" }, h("slot", { key: 'aed07a34c22e4b1f34cdf40fea35481674d8941f' }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "size": ["sizeChanged"]
