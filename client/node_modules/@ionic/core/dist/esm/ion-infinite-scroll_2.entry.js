...
const InfiniteScrollContent = class {
    ...
    render() {
        const mode = getIonMode(this);
        return (h(Host, { key: '38c67d2c7ea4c304e71dacea64add0bffab69906', class: {
                [mode]: true,
                // Used internally for styling
                [`infinite-scroll-content-${mode}`]: true,
            } }, h("div", { key: 'a23484ccbaf65e0e3ecb59befea425cfdbc782fd', class: "infinite-loading" }, this.loadingSpinner && (h("div", { class: "infinite-loading-spinner" }, h("ion-spinner", { name: this.loadingSpinner }))), this.loadingText !== undefined && this.renderLoadingText())));
    }
};
